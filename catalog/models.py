...
# ManyToManyField used because genre can con-tain many books. Books can cover many genres.
...
class BookInstance(models.Model):
    ...
    help_text="Unique ID for this partic-ular book across whole library"
    )
